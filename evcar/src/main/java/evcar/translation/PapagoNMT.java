...
public class PapagoNMT {
	...
	public static String VIETANAMESE = "vi";
	
	//파파고  API 서버 주소
	private static String apiURL = "https://openapi.naver.com/v1/papago/n2mt";
			
	//애플리케이션 클라이언트 아이디값";
	private static String clientId = "lpL1iNwBN2bTCH1ZmZR7";
	//애플리케이션 클라이언트 시크릿값";
	private static String clientSecret = "OLcHthF5a8";
	
	//차례대로 '변환할 언어', '변활될 언어', '변환활 문장'
	public static String translate(String source, String target, String text){
		try{
			...
			return "파파고 API 통신 중에 오류가 발생하였습니다.";
		}
	}
}
